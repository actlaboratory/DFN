...
* ビープ音
    * NVDA 2026.2 以上
        * ショートカットキー操作で理療科用読み辞書を有効にした: ピ
        * ショートカットキー操作で理療科用読み辞書を無効にした: ピピ
    * NVDA 2026.1 以下
...
NVDA 2026.2以上の起動直後には、辞書適用に関するお知らせはありません。

* NVDAメニューから「読ター For NVDA」を選択し、起動時の理療科用読み辞書の状態を選択。
    * NVDA 2026.2以上では、有効、無効、または前回と同じを実行
    * NVDA 2026.1以下では、有効、または無効を実行。
...
(c) 2021-2026 Hiroki Fujii - ACT Laboratory
...
* 1.2.0 (2026/07/02)
    * NVDA 2026.2に対応
    * NVDA 2026.2より実装された読み上げ辞書アドオンに準拠
    * NVDA2026.2以上で、処理のお知らせ方法を修正
    * NVDA2026.2以上で、前回の辞書状態を保持する設定を追加
    * メニュー構成の一部変更
